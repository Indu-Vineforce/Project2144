...
public abstract class Project2144WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static Project2144WebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(Project2144WebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<Project2144DbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<Project2144DbContext, Task> action)
    {
        using (var context = IocManager.Resolve<Project2144DbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<Project2144DbContext, Task<T>> func)
    {
        T result;
