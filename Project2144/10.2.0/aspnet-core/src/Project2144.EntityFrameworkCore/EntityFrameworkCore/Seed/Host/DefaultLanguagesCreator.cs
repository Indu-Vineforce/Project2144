...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = Project2144Consts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(Project2144DbContext context)
    {
        _context = context;
    }
