...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project2144.CSC.Country", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project2144.CSC.State", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project2144.Cities.City", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Project2144.Skills.Skill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Project2144.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Project2144.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Project2144.CSC.State", b =>
                {
                    b.HasOne("Project2144.CSC.Country", "Country")
                        .WithMany("States")
            ...
            modelBuilder.Entity("Project2144.Cities.City", b =>
                {
                    ...
                    b.HasOne("Project2144.CSC.State", "State")
                        .WithMany("Cities")
